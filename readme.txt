                  ...
                  beta release version 2001.04.14
                           2001 Elecbyte
                             ---------
      ...
      --------------------------------------------------------------
      UPDATE NOTICE: 
           - Characters from 2000.01.01 and earlier versions of MUGEN
             are not compatible with this version. Please refer to
             incompt2.txt for details on how to make your
...
compiled with gcc 2.95.2 and linked with Allegro 3.9.34 WIP.
...
Note that you cannot enable more than one joystick at a time.

Most popular joysticks work in 4 or 6 button mode. Sidewinder and
SNESKey pads are supported by Allegro, but have not been tested. PSX
joypads are supported through a DirectPad Pro PSX converter. You can
find converter building instructions at www.ziplabel.com.
...
i. Run in DOS
   ...
   Your sound card may need DOS drivers for you to hear sound.
   Contact your sound card manufacturer for drivers.
...
iii. Reduce the number of characters
...
By using MUGEN beta 2001.04.14, you agree to the following terms and
conditions of use:

1. MUGEN version 2001.04.14 is beta software. You agree to indemnify
...
2001.04.14 to operate properly, whether through deficiencies of the
software or through user error. Elecbyte disclaims all express and
implied warranties, including but not limited to warranties of
merchantability and fitness for a particular purpose.

2. The MUGEN environment, defined as any or all of the 2001.04.14
...
MUGEN 2001.04.14 environment, as long as said distribution is pursuant
...
environment, version 2001.04.14, until and not beyond 12:01 AM
(Greenwich Mean Time) on August 1, 2001. After this time, Elecbyte may,
...
continued use of the MUGEN 2001.04.14 beta. If no new license is
offered, all use of the 2001.04.14 beta must cease.
